...
corniBassII_mvtI = \relative do'
{
    ...
    do do do-. do |
    do8.-\sf r16 do8.-\sf r16 |
    re'8.-\sf r16 re8.-\sf r16 |
    sol,8.-\> r16 sol,8. r16 |
    sol'2-\pdolce ~ |
    sol |
    do4.( re16 mi) |
    mi8( re16 do) do8( sol16 mi) |
    sol2 ~ |
    sol4 sol, ~ |
    \bar "||"
    sol4. sol8 ~ |
